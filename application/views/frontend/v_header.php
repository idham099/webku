...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url().'/gambar/website/'.$pengaturan->logo; ?>" rel="icon" class="img-circle">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/about-me');?>">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/service');?>">Services</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/contact');?>">Contact</a>
          </li>
          <li class="nav-item">
