...
<div class="widget-sidebar">
    <h5 class="sidebar-title">New Article</h5>
    <div class="sidebar-content">
    <ul class="list-sidebar">
    <?php $artikel = $this->db->query("SELECT * FROM artikel,pengguna,kategori WHERE artikel_status='publish' AND artikel_author=pengguna_id AND artikel_kategori = kategori_id ORDER BY artikel_id DESC LIMIT 6")->result();
...
<div class="widget-sidebar">
 <h5 class="sidebar-title">Page</h5>
    <div class="sidebar-content">
        <ul class="list-sidebar">
            <?php
