<div class="content-wrapper">
    ...
    <section class="content">
        <a href="<?php echo base_url().'dashboard/artikel'; ?>" class="btn btn-sm btn-success"
                ...
                <div class="col-lg-3">
                    <div class="box box-success">
                        <div class="box-body">
                            ...
                            <input type="submit" name="status" class="btn btn-success btn-block" value="Publish">
                            
                            <input type="submit" name="status" class="btn btn-warning btn-block" value="Draft">
