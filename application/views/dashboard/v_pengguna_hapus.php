<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-12">
                <a href="<?php echo base_url().'dashboard/pengguna';?>" class="btn btn-sm btn-success"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <p>Nama pengguna <b><?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dihapus. dan semua artikel yang ditulis oleh <b><?php echo $pengguna_hapus->pengguna_nama;?></b> akan dipindahkan ke ?</p>
