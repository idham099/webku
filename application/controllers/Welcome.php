...
class Welcome extends CI_Controller {
	...
	{
		$data['artikel'] = $this->db->query("SELECT * FROM artikel,pengguna,kategori WHERE artikel_status='publish' AND artikel_author=pengguna_id AND artikel_kategori=kategori_id ORDER BY artikel_id DESC LIMIT 6")->result();
    ...
    public function kategori($slug)
    {
        ...
        $config['first_tag_open'] = '<li class="page-item"> <span class="page-link">';
        $config['first_tagl_close'] = '</span></li>';
        $config['last_tag_open'] = '<li calss="page-item"><span class="page-link">';
        $config['last_tagl_close'] = '</span></li>';
